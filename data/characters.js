const CHARACTERS = {
  ...
  ichigo_base: {
    ...
    base_stats:{ damage:75, range:91, attack_speed:1.4, type:'single_target' },
    deploy_cost:150, max_level:50,
    upgrades:[
      { name:'Getsugatensho',    desc:'Tipo → Linha | Dano ×1.3',                        type:'linha', damage_mult:1.3,                                      cost:170 },
      { name:'Bankai Parcial',   desc:'Alcance ×1.2 | Vel ×1.2',                          range_mult:1.13, speed_mult:1.2,                                      cost:340 },
      ...
      { name:'Bankai Completo',  desc:'Dano ×1.7 | Vel ×1.2 | Alcance ×1.1',             damage_mult:1.7, speed_mult:1.2, range_mult:1.06,                     cost:1100 }
    ]
  },
  ...
  goku_base: {
    ...
    base_stats:{ damage:90, range:94, attack_speed:1.1, type:'single_target' },
    deploy_cost:150, max_level:50,
    upgrades:[
  ...
  l_deathnote: {
    ...
    deploy_cost:150, max_level:50,
    upgrades:[
      { name:'Planejamento',         desc:'+30 ouro/wave | Alcance ×1.2',                  gold_bonus:30, range_mult:1.13,                                       cost:160 },
      ...
      { name:'Kira Identificado',    desc:'+80 ouro/wave | kill bonus → 15 ouro | Alcance ×1.3', gold_bonus:80, kill_gold:15, range_mult:1.20,                  cost:750 }
    ]
  },
  ...
  demolidor: {
    ...
    base_stats:{ damage:68, range:84, attack_speed:1.4, type:'single_target' },
    deploy_cost:150, max_level:50,
    upgrades:[
      { name:'Sentidos Aguçados', desc:'Alcance ×1.35 | Slow → 35%',                       range_mult:1.23, passive_override:{ slow_pct:0.35 },                 cost:165 },
  ...
  sasuke_uchiha: {
    ...
    base_stats:{ damage:70, range:104, attack_speed:0.9, type:'single_target' },
    deploy_cost:150, max_level:50,
    upgrades:[
      { name:'Chidori',          desc:'Tipo → Linha | Dano ×1.5',                          type:'linha', damage_mult:1.5,                                       cost:180 },
      { name:'Susanoo Parcial',  desc:'Alcance ×1.2 | Dano ×1.3',                          range_mult:1.13, damage_mult:1.3,                                     cost:370 },
      ...
      { name:'Susanoo Completo', desc:'Dano ×1.6 | Burn → 30 DPS / 4s | Alcance ×1.1',   damage_mult:1.6, range_mult:1.06, status_effect:{ type:'burn', dps:30, duration:4 }, cost:950 }
    ]
  },
  ...
  killua_zoldyck: {
    ...
    base_stats:{ damage:60, range:78, attack_speed:2.0, type:'single_target' },
    deploy_cost:150, max_level:50,
    upgrades:[
  ...
  tanjiro_kamado: {
    ...
    base_stats:{ damage:78, range:91, attack_speed:1.1, type:'single_target' },
    deploy_cost:150, max_level:50,
    upgrades:[
      ...
      { name:'Respiração Solar',  desc:'Dano ×1.5 | Alcance ×1.1',                         damage_mult:1.5, range_mult:1.06,                                      cost:360 },
  ...
  // Zoro — Spike de Dano (Santoryu) | 6 upgrades
  // Single → Linha | 3° acerto escala de 3× → 5×
  zoro_base: {
    id:'zoro_base', name:'Roronoa Zoro', rarity:3, series:'onepiece', playable:true, xp_value:1000, initials:'RZ',
    image: 'assets/towers/update1/Zoro.png',
    passive:{ type:'three_swords', mult:3,
      label:'Santoryu: a cada 3 ataques, o terceiro causa 3× de dano' },
    base_stats:{ damage:85, range:83, attack_speed:1.0, type:'single_target' },
    deploy_cost:150, max_level:50,
    upgrades:[
      { name:'Oni Giri',          desc:'Tipo → Linha | Dano ×1.3',                         type:'linha', damage_mult:1.3,                                       cost:170 },
      { name:'36 Sentidos',       desc:'Alcance ×1.25 | Vel ×1.2',                         range_mult:1.16, speed_mult:1.2,                                     cost:350 },
      { name:'Tora Gari',         desc:'Dano ×1.4 | 3° acerto → 3.5×',                    damage_mult:1.4, passive_override:{ mult:3.5 },                      cost:500 },
      { name:'Pulo do Leopardo',  desc:'Vel ×1.2 | Alcance ×1.1',                          speed_mult:1.2, range_mult:1.06,                                      cost:680 },
      { name:'Sen Pou',           desc:'Dano ×1.5 | 3° acerto → 4×',                      damage_mult:1.5, passive_override:{ mult:4 },                        cost:850 },
      { name:'Dragon Twister',    desc:'Dano ×1.6 | Vel ×1.1 | 3° acerto → 5×',          damage_mult:1.6, speed_mult:1.1, passive_override:{ mult:5 },        cost:1100 }
    ]
  },
  ...
  naruto_shippuden: {
    ...
    base_stats:{ damage:148, range:113, attack_speed:1.3, type:'aoe' },
    ...
    upgrades:[
      ...
      { name:'Rasengan Gigante',  desc:'Dano ×1.4 | Alcance ×1.1',                          damage_mult:1.4, range_mult:1.06,                                     cost:580 },
      { name:'Modo Sábio',        desc:'Vel ×1.2 | Alcance ×1.15 | Kill CD → 90% reduzido', speed_mult:1.2, range_mult:1.10, passive_override:{ reduction:0.10 }, cost:750 },
      { name:'Rasenshuriken',     desc:'Dano ×1.7 | Vel ×0.85',                             damage_mult:1.7, speed_mult:0.85,                                    cost:950 },
      { name:'Modo Bijuu',        desc:'Dano ×1.5 | Vel ×1.15 | Alcance ×1.1',             damage_mult:1.5, speed_mult:1.15, range_mult:1.06,                    cost:1300 }
    ]
  },

  // Luffy — Fogo Rápido → Golpe AOE Pesado | 6 upgrades
  // Single rápido com burn → AOE lento e devastador no Gear Third
  luffy_base: {
    id:'luffy_base', name:'Luffy (Base)', rarity:4, series:'onepiece', playable:true, xp_value:3000, initials:'LB',
    image: 'assets/towers/update1/Luffy.png',
    passive:{ type:'status_on_hit', status:'burn', dps:25, duration:3,
      label:'Espírito Pirata: cada acerto incendeia o inimigo (25 DPS/3s)' },
    base_stats:{ damage:125, range:104, attack_speed:1.6, type:'single_target' },
    deploy_cost:300, max_level:50,
    upgrades:[
      { name:'Pistola Gomu',      desc:'Alcance ×1.35 | Dano ×1.2',                        range_mult:1.23, damage_mult:1.2,                                    cost:185 },
      { name:'Gear Second',       desc:'Vel ×1.5 | Alcance ×0.9',                           speed_mult:1.5, range_mult:0.94,                                      cost:370 },
      { name:'Bazooka Gomu',      desc:'Dano ×1.6 | Burn → 30 DPS',                        damage_mult:1.6, passive_override:{ dps:30 },                        cost:550 },
      { name:'Gear Third',        desc:'Tipo → AOE | Dano ×1.8 | Vel ×0.55',              type:'aoe', damage_mult:1.8, speed_mult:0.55,                         cost:800 },
      { name:'Elephant Gun',      desc:'Dano ×1.4 | Alcance ×1.2',                          damage_mult:1.4, range_mult:1.13,                                     cost:1000 },
      { name:'Gear Fourth',       desc:'Vel ×1.5 | Dano ×1.5 | Burn → 40 DPS / 5s',      speed_mult:1.5, damage_mult:1.5, passive_override:{ dps:40, duration:5 }, cost:1400 }
    ]
  },
  ...
  levi_ackerman: {
    ...
    base_stats:{ damage:128, range:104, attack_speed:1.7, type:'single_target' },
    deploy_cost:300, max_level:50,
    upgrades:[
      ...
      { name:'Chacina de Titãs',    desc:'Alcance ×1.2 | Vel ×1.1',                        range_mult:1.13, speed_mult:1.1,                                      cost:550 },
  ...
  meliodas_base: {
    ...
    base_stats:{ damage:138, range:104, attack_speed:1.25, type:'single_target' },
    deploy_cost:300, max_level:50,
    upgrades:[
      ...
      { name:'Poder dos Demônios',desc:'Dano ×1.8 | Alcance ×1.1 | Burn → 28 | Bleed → 18', damage_mult:1.8, range_mult:1.06, passive_override:{ burn_dps:28, bleed_dps:18 }, cost:1300 }
    ]
  },
  ...
  naruto_sage: {
    ...
    base_stats:{ damage:280, range:130, attack_speed:2.2, type:'single_target' },
    deploy_cost:500, max_level:50,
    upgrades:[
      { name:'Senjutsu',            desc:'Dano ×1.35 | Alcance ×1.1 | Clone chance → 20%',  damage_mult:1.35, range_mult:1.06, passive_override:{ chance:0.20 },          cost:400 },
      ...
      { name:'Monte Myoboku',       desc:'Vel ×1.15 | Alcance ×1.1 | Clone chance → 25%',    speed_mult:1.15, range_mult:1.06, passive_override:{ chance:0.25 },           cost:1300 },
  ...
  gojo_satoru: {
    ...
    base_stats:{ damage:370, range:123, attack_speed:1.7, type:'aoe_full' },
    deploy_cost:500, max_level:50,
    upgrades:[
      { name:'Infinito',        desc:'Dano ×1.25 | Alcance ×1.15',                        damage_mult:1.25, range_mult:1.10,                                   cost:420 },
      { name:'Vermelho Maldito',desc:'Vel ×1.2 | Dano ×1.2',                               speed_mult:1.2, damage_mult:1.2,                                     cost:750 },
      { name:'Azul Maldito',    desc:'Alcance ×1.1 | Aura → +30% | Stun → 4s',           range_mult:1.06, passive_override:{ bonus:0.30 }, active_override:{ stun_duration:4 }, cost:1100 },
      { name:'Violeta Oco',     desc:'Dano ×1.8 | Vel ×1.15 | Alcance ×1.1',             damage_mult:1.8, speed_mult:1.15, range_mult:1.06,                    cost:1700 }
    ]
  },

  // ── Ingredients (One Piece) ──
  pirata_generico_1: { id:'pirata_generico_1', name:'Pirata Novato',   rarity:0, series:'onepiece', playable:false, xp_value:60, initials:'P1', image: 'assets/ingredients/world1/Ninja 1.png', upgrades_to:'pirata_generico_2', upgrade_cost:3 },
  pirata_generico_2: { id:'pirata_generico_2', name:'Pirata Saqueador',  rarity:1, series:'onepiece', playable:false, xp_value:180, initials:'P2', image: 'assets/ingredients/world1/Ninja 2.png', upgrades_to:'pirata_generico_3', upgrade_cost:3 },
  pirata_generico_3: { id:'pirata_generico_3', name:'Pirata Veterano', rarity:2, series:'onepiece', playable:false, xp_value:500, initials:'P3', image: 'assets/ingredients/world1/Ninja 3.png' },
  ...
  luffy_3: {
    ...
    image: 'assets/towers/update1/Luffy.png',
    passive:{ type:'none' },
    base_stats:{ damage:108, range:70, attack_speed:1.6, type:'single_target' },
  ...
  zoro_3: {
    ...
    image: 'assets/towers/update1/Zoro.png',
    passive:{ type:'none' },
    base_stats:{ damage:144, range:60, attack_speed:1.2, type:'cone' },
    deploy_cost:140, max_level:50,
    upgrades:[
      { name:'Oni Giri', desc:'Dano ×1.5', damage_mult:1.5, cost:200 },
      { name:'Tatsumaki', desc:'Alcance ×1.2 | Dano ×1.3', range_mult:1.2, damage_mult:1.3, cost:400 }
    ]
  },
  nami_3: {
    ...
    base_stats:{ damage:72, range:90, attack_speed:1.0, type:'cone' },
    deploy_cost:150, max_level:50,
    upgrades:[
  ...
  usopp_3: {
    ...
    base_stats:{ damage:84, range:200, attack_speed:0.8, type:'single_target' },
    deploy_cost:160, max_level:50,
    upgrades:[
      { name:'Estilingue Kabuto', desc:'Dano ×1.4', damage_mult:1.4, cost:200 },
      { name:'Firebird Star', desc:'Dano ×1.5 | Alcance ×1.1', damage_mult:1.5, range_mult:1.1, cost:400 }
    ]
  },
  brook_3: {
    ...
    base_stats:{ damage:60, range:120, attack_speed:1.5, type:'linha' },
  ...
  sanji_4: {
    ...
    base_stats:{ damage:216, range:65, attack_speed:1.8, type:'single_target' },
  ...
  robin_4: {
    ...
    base_stats:{ damage:168, range:100, attack_speed:0.9, type:'aoe_full' },
    deploy_cost:300, max_level:50,
    upgrades:[
      { name:'Clutch', desc:'Dano ×1.5', damage_mult:1.5, cost:350 },
      { name:'Gigantesco Mano', desc:'Alcance ×1.2 | Dano ×1.4', range_mult:1.2, damage_mult:1.4, cost:700 }
    ]
  },
  ace_4: {
    ...
    base_stats:{ damage:264, range:110, attack_speed:1.0, type:'cone' },
  ...
  zoro_5: {
    ...
    image: 'assets/towers/update1/Zoro_Ashura.png',
    evolution: {
      source: 'zoro_3',
      requires: [
...
const ALL_CHARACTERS_POOL = {
  star3: ['ichigo_base','goku_base','l_deathnote','demolidor','sasuke_uchiha','killua_zoldyck','tanjiro_kamado','zoro_base','luffy_3','zoro_3','nami_3','usopp_3','brook_3'],
  star4: ['naruto_shippuden','luffy_base','levi_ackerman','meliodas_base','sanji_4','robin_4','ace_4'],

...
const NEXUS_STRUCTURES = [
  { id: 'hospital',   name: 'Hospital de Campo',       icon: '🏥', maxLevel: 5, baseCost: 1800,  costPerLevel: 1200,
    desc: '+1 vida inicial por nível.',
    materials: [{ id: 'ninja_generico_1', qty: 4 }, { id: 'pirata_generico_1', qty: 4 }] },
  { id: 'vault',      name: 'Cofre de Suprimentos',    icon: '💰', maxLevel: 5, baseCost: 1800,  costPerLevel: 1200,
    desc: '+60 de ouro inicial por nível.',
    materials: [{ id: 'avenger_material_1', qty: 5 }, { id: 'dc_material_1', qty: 5 }] },
  { id: 'academia',   name: 'Academia de Heróis',      icon: '📚', maxLevel: 3, baseCost: 2400, costPerLevel: 1800,
    desc: '+15% XP de feed por nível.',
    materials: [{ id: 'ninja_generico_2', qty: 5 }, { id: 'shinigami_generico_2', qty: 5 }] },
  { id: 'watchtower', name: 'Torre de Vigilância',     icon: '🗼', maxLevel: 3, baseCost: 3000, costPerLevel: 2400,
  ...
  { id: 'forge',      name: 'Forja de Relíquias',      icon: '⚒',  maxLevel: 3, baseCost: 3600, costPerLevel: 3000,
  ...
  { id: 'barracks',   name: 'Quartel',                 icon: '🏛',  maxLevel: 3, baseCost: 2100, costPerLevel: 1800,
    desc: '-8% de custo de deploy de todas as torres por nível.',
    materials: [{ id: 'ninja_generico_1', qty: 6 }, { id: 'pirata_generico_1', qty: 6 }] },
  { id: 'lab',        name: 'Laboratório de Campo',    icon: '🔬', maxLevel: 3, baseCost: 2700, costPerLevel: 2100,
  ...
  { id: 'bank',       name: 'Banco de Guerra',         icon: '🏦', maxLevel: 3, baseCost: 2400, costPerLevel: 1800,
  ...
  { id: 'temple',     name: 'Templo dos Campeões',     icon: '⛩',  maxLevel: 4, baseCost: 3300, costPerLevel: 2400,
    desc: '+5% de dano global de todas as torres por nível.',
    materials: [{ id: 'avenger_material_3', qty: 4 }, { id: 'shinigami_generico_3', qty: 4 }] },
  { id: 'relay',      name: 'Centro de Retransmissão', icon: '📡', maxLevel: 3, baseCost: 3000, costPerLevel: 2400,

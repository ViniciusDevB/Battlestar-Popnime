...
const ENEMY_DEFS = {
  ...
  ninja_comum: {
    ...
    ptype:'normal', req:0, size:18, col:'#c0392b', image: 'assets/inimigos/world1/world1/Ninja Comum.png'
  },
  ...
  ninja_ambu: {
    ...
    ptype:'normal', req:0, size:18, col:'#7f8c8d', image: 'assets/inimigos/world1/world1/Ninja Ambu.png'
  },
  agente_ambu: {
    id:'agente_ambu', name:'Agente Ambu',
    hp:700, speed:72, gold:44,
    ptype:'powerful1', req:1, size:22, col:'#2c3e50', image: 'assets/inimigos/world1/world1/Ninja Ambu.png'
  },
  ...
  serpente: {
    ...
    ptype:'normal', req:0, size:20, col:'#27ae60', image: 'assets/inimigos/world1/world1/Cobra.png'
  },
  boa_constritora: {
    id:'boa_constritora', name:'Boa Constritora',
    hp:1300, speed:68, gold:71,
    ptype:'powerful1', req:1, size:24, col:'#1e8449', image: 'assets/inimigos/world1/world1/Cobra Constritora.png'
  },
  ...
  caminho_animal: {
    ...
    ptype:'normal', req:0, size:20, col:'#884ea0', image: 'assets/inimigos/world1/world1/Pain Caminho Animal.png'
  },
  caminho_humano: {
    id:'caminho_humano', name:'Caminho Humano',
    hp:2000, speed:64, gold:95,
    ptype:'powerful1', req:1, size:24, col:'#6c3483', image: 'assets/inimigos/world1/world1/Pain Caminho Humano.png'
  },
  ...
  invocacao_slug: {
    ...
    ptype:'normal', req:0, size:22, col:'#5dade2', image: 'assets/inimigos/world1/world1/Invocação Slug.png'
  },
  invocacao_caranguejo: {
    id:'invocacao_caranguejo', name:'Caranguejo Invocado',
    hp:3000, speed:56, gold:131,
    ptype:'powerful1', req:1, size:26, col:'#1a5276', image: 'assets/inimigos/world1/world1/Invocação Carangueijo.png'
  },
  ...
  ninja_chuva: {
    ...
    ptype:'normal', req:0, size:20, col:'#5d6d7e', image: 'assets/inimigos/world1/world1/Ninja Chuva.png'
  },
  akatsuki_chuva: {
    id:'akatsuki_chuva', name:'Akatsuki da Chuva',
    hp:4000, speed:65, gold:163,
    ptype:'powerful1', req:1, size:24, col:'#4a235a', image: 'assets/inimigos/world1/world1/Ninja Akatsuki.png'
  },
  mini_shinra_tensei: {
    id:'mini_shinra_tensei', name:'Mini Shinra Tensei',
    hp:800, speed:76, gold:53,
    ptype:'normal', req:0, size:18, col:'#e74c3c', image: 'assets/inimigos/world1/world1/Shinra Tensei.png',
  ...
  ninja_chuva_veloz: {
    ...
    ptype:'speed', req:0, size:16, col:'#85929e', image: 'assets/inimigos/world1/world1/Ninja Akatsuki.png'
  },
  ...
  deidara: {
    ...
    ptype:'normal', req:0, size:32, col:'#f39c12', image: 'assets/inimigos/world1/world1/Deidara.png',
    is_miniboss:true,
  ...
  itachi_uchiha: {
    ...
    ptype:'powerful1', req:1, size:32, col:'#1c2833', image: 'assets/inimigos/world1/world1/Itachi.png',
    is_miniboss:true,
  ...
  sasuke_taka: {
    ...
    ptype:'powerful1', req:1, size:32, col:'#1f618d', image: 'assets/inimigos/world1/world1/Sasuke Taka (1).png',
    is_miniboss:true,
  ...
  konan: {
    ...
    ptype:'powerful1', req:1, size:34, col:'#9b59b6', image: 'assets/inimigos/world1/world1/Konan.png',
    is_miniboss:true,
  ...
  caminho_deus_animal: {
    ...
    ptype:'powerful1', req:1, size:36, col:'#7d6608', image: 'assets/inimigos/world1/world1/Pain Caminho Animal.png',
    is_miniboss:true,
  ...
  pain: {
    ...
    ptype:'powerful3', req:3, size:44, col:'#922b21', image: 'assets/inimigos/world1/world1/Pain.png',
    is_boss:true,
